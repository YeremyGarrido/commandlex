...
export default function HomePage({ initialCommands }: HomePageProps) {
  // --- Estados Locales (Solo para datos y UI) ---
  // Ya no necesitamos estado para 'allCommands' porque viene por props y no cambia en el cliente por ahora.
  const allCommands = initialCommands;
  
  // const [loading, setLoading] = useState(true); // ELIMINADO: Data viene del servidor
